        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div className="flex flex-col justify-center">
            <motion.h2
              ...
              className="font-serif text-3xl md:text-4xl lg:text-5xl text-white leading-[1.3] mb-8"
            >
              Если вы чувствуете, что мой подход вам близок — давайте обсудим ваш проект.
            </motion.h2>
