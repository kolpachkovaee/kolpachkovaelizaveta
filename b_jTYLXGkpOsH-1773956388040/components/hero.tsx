      ...
      <div className="min-h-screen flex flex-col justify-center px-6 md:px-12 lg:px-24 pt-24">
        <div className="max-w-5xl">
          ...
          <motion.h1
            ...
            className="font-serif text-[#1a1a1a] text-3xl md:text-4xl lg:text-5xl leading-[1.3] tracking-wide mb-16 max-w-4xl"
          >
            Создаю визуальные решения, которые помогают вашему бизнесу расти, выделяться и вызывать доверие с первых секунд.
          </motion.h1>
