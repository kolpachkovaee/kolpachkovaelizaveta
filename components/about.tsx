    ...
    <section id="about" className="bg-[#f5f5f3] py-32 lg:py-48" ref={ref}>
      ...
      <div className="px-6 md:px-12 lg:px-24 mb-24">
        ...
        <motion.h2
          ...
          className="font-playfair text-4xl md:text-5xl lg:text-6xl text-[#1a1a1a] max-w-4xl leading-[1.25]"
        >
          Здравствуйте! Меня зовут <span className="font-playfair italic">Елизавета,</span> я графический дизайнер.
        </motion.h2>
      </div>
      ...
      <motion.p
        ...
        className="px-6 md:px-12 lg:px-24 mt-24 mb-6 text-xs tracking-[0.3em] text-[#999]"
      >
